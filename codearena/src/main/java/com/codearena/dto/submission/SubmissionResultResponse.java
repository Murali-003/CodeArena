...
public class SubmissionResultResponse {
    ...
    public static SubmissionResultResponse fromEntity(SubmissionResult r, boolean includeOutput) {
        return SubmissionResultResponse.builder()
                ...
                .executionTimeMs(r.getExecutionTimeMs() == null ? 0 : r.getExecutionTimeMs())
                .memoryUsedKb(r.getMemoryUsedKb() == null ? 0 : r.getMemoryUsedKb())
